...
faculty_Process[count].arrival_time;
 printf("\n|\t \t%s \t |\t %d\t \t |\t\t %d \t|\t %d\t\t |\n",
faculty_Process[count].process_name, faculty_Process[count].arrival_time,
faculty_Process[count].burst_time, faculty_Process[count].completion_time);
 }
}
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n");
 printf("\n|\tProcess Name\t |\tArrival Time\t |\tBurst Time\t |\tCompletion Time \t|\n");
 for(count = 0; count < no_of_process; count++){
 waiting_time = student_Process[count].completion_time - student_Process[count].burst_time -
student_Process[count].arrival_time;
 printf("\n|\t \t%s \t |\t %d\t \t |\t\t %d \t|\t %d\t\t |\n",
student_Process[count].process_name, student_Process[count].arrival_time,
student_Process[count].burst_time, student_Process[count].completion_time);
 }
}
